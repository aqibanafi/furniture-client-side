...
const DashbaordRightBar = () => {
    ...
    return (
        <div className='bg-primary p-5'>
            ...
            <div>
                <p className='text-white font-bold mb-2'><span className='text-lg mr-2'>User Name:</span> <span className='text-yellow-600 text-2xl'>{user?.displayName}</span></p>
                <p className='text-white font-bold mb-2'><span className='text-lg'>Email:</span> <span className='text-yellow-600 text-xl'>{user?.email}</span></p>
