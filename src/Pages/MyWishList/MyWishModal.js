...
const MyWishModal = ({ productBooked, myWishList }) => {
    ...
    const { name, picture, location, resealablePrice, originalPrice, yearOfUse, postTime, sellersName, _id } = myWishList;
